...
| 🔂 輸出控制 | 數字／符號可切換全形輸出；打出字後**空間鍵顯示另一種輸入法的提示**（嘸蝦米→注音、注音→嘸蝦米拆碼），邊打邊學 |
...
- **v1.0.19**：空間鍵提示改為**互補教學**——嘸蝦米打出字顯示注音、注音打出字顯示嘸蝦米拆碼
- **v1.0.18**：注音**連打組詞**（ㄨㄢㄕㄤ→晚上、自動補聲調、可續打第二音節）；`Space`＝直接送出候選第一項；雙字詞會自動學習
